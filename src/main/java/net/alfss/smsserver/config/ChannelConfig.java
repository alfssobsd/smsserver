...
public class ChannelConfig {
    ...
    private boolean enablePlayLoad;
    ...
    public ChannelConfig(HierarchicalConfiguration configuration) {
        ...
        setEnablePlayLoad(configuration.getBoolean("enable-playload", false));
    ...
    public boolean getEnablePlayLoad() {
        return enablePlayLoad;
    }

    public void setEnablePlayLoad(boolean enablePlayLoad) {
        this.enablePlayLoad = enablePlayLoad;
    }
